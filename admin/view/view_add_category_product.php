	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
			...
			<div class="row" style="margin-top:5px;">
				...
				<div class="col-lg-8">
					<input value="" type="text" name="c_name" maxlength="50" class="form-control" required="required"  >
				</div>
			</div>
			<!-- end row -->
			...
			<div class="row" style="margin-top:5px;">
                ...
                <select name="pk_category_product">
					...
					?>
                	<option value="<?php echo $danhmcucha["pk_category_product_id"]?>" class="form-control"><?php echo $danhmcucha["c_name"]?></option>
                    <?php }?>
