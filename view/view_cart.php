...
<div class="container">
	<div class="check-out">
		...
		<div class="produced" style="margin-top:10px">
			<?php if (cart_number() > 0) { ?>
				<a target="_blank" href="https://www.nganluong.vn/button_payment.php?receiver=nguyenvandung23041995@gmail.com&product_name=1234&price=<?php echo cart_total() ?>&return_url=http://localhost/cnm/index.php?controller=cart&comments=(Ghi chú về đơn hàng)"><img src="https://www.nganluong.vn/css/newhome/img/button/pay-lg.png" border="0" /></a>
			<?php } ?>
		</div>
