...
<body>
	...
	<div class="header">
		<div class="container">
			<div class="head">
				<div class=" logo">
					<a href="index.php"><img src="public/images/logo2.jpg" alt=""></a>
				</div>
			</div>
		</div>
	...
	<div class="brand">
		<div class="col-md-3 brand-grid">
			<img src="public/images/ic11.jpg" class="img-responsive" alt="">
		</div>
		<div class="col-md-3 brand-grid">
			<img src="public/images/ic12.jpg" class="img-responsive" alt="">
		</div>
		<div class="col-md-3 brand-grid">
			<img src="public/images/ic13.jpg" class="img-responsive" alt="">
		</div>
		<div class="col-md-3 brand-grid">
			<img src="public/images/ic14.jpg" class="img-responsive" alt="">
		</div>
		<div class="clearfix"></div>
	</div>
	<!--//brand-->
	...
	<div class="footer">
		<div class="footer-middle">
			<div class="container">
				<div class="col-md-3 footer-middle-in">
					<a href="index.html"><img src="public/images/nh17.png" alt=""></a>
					<p>Hiện nay, thương hiệu nước hoa Perfume phát triển ngày càng lớn mạnh. Ngoài ra, nhằm tạo sự tiện lợi mua sắm tối đa cho khách hàng, Shopin phát triển hệ thống bán hàng online, giao hàng đến tận tay người tiêu dùng.</p>
				</div>
		...
		<div class="footer-bottom">
			<div class="container">
				...
				<p class="footer-class">&copy; 2021 Perfume | Design by <a href="https://www.facebook.com/profile.php?id=100073250846168" target="_blank">Yến Linh and Minh Mẫn</a> </p>
				<div class="clearfix"> </div>
			</div>
		</div>
	</div>
