...
<div class="banner-top">
	<div class="container">
		<h1>Nước Hoa Nam</h1>
		<em></em>
		<h2><a href="index.php">Home</a><label>/</label>Nước Hoa Nam</a></h2>
	</div>
</div>
<!--content-->
<div class="product">
							...
							<div class="mid-1">
								<div class="women">
									...
									<div class="img item_add">
										<a href="index.php?controller=cart&act=add&id=<?php echo $product_men["pk_product_id"] ?>"><img src="public/images/ca.png" alt=""></a>
									</div>
